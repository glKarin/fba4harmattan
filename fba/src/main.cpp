...
*/
	...
	config_keymap.up=SDLK_w;//UP;
	config_keymap.down=SDLK_s;//DOWN;
	config_keymap.left=SDLK_a;//LEFT;
	config_keymap.right=SDLK_d;//RIGHT;
	config_keymap.fire1=SDLK_j;//HOME; //a
	config_keymap.fire2=SDLK_k;//PAGEDOWN; //x
	config_keymap.fire3=SDLK_u;//END; //b
	config_keymap.fire4=SDLK_i;//PAGEUP; //y
	config_keymap.fire5=SDLK_l;//RSHIFT;
	config_keymap.fire6=SDLK_o;//RCTRL;
	config_keymap.coin1=SDLK_m;//LCTRL;
	config_keymap.start1=SDLK_n;//LALT;
	config_keymap.pause=SDLK_RETURN;//p;
	config_keymap.quit=SDLK_RCTRL;//q;
